...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./lib/view/assets-development/javascript/vue-components/archive/browser.vue?vue&type=template&id=65e99a0e&
...
;// CONCATENATED MODULE: ./lib/view/assets-development/javascript/vue-components/archive/browser.vue?vue&type=template&id=65e99a0e&
...
/* harmony default export */ var browservue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    event_bus.$on('ai1wm-download-backup', this.downloadBackup);
  },
  methods: {
    ...
    downloadBackup: function downloadBackup(file) {
      ...
      request.addEventListener('readystatechange', function () {
        if (request.readyState === 2 && request.status === 200) {// Download is being started
          ...
          // Downloading has finished
          if (request.status < 400) {
            (0,FileSaver_min.saveAs)(request.response, Ai1wm.Util.basename(file));
          } else {
            /* eslint-disable no-alert */
            alert(ai1wm_locale.archive_browser_download_error);
            /* eslint-enable no-alert */
...
jQuery(document).ready(function ($) {
  ...
  $('#ai1wm-backups-list').on('click', '.ai1wm-backup-download', function (e) {
    e.preventDefault();
    var file = $(this).prop('download');
    event_bus.$emit('ai1wm-download-backup', file);
    return false;
  });
